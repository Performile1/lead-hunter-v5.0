...
export const CustomerDetail: React.FC<CustomerDetailProps> = ({ customerId, onBack }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FFCC00]/10 to-white flex items-center justify-center">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FFCC00]/10 to-white flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={onBack} className="mt-4 text-[#D40511] font-bold hover:underline">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFCC00]/10 to-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-[#D40511] hover:text-[#a0040d] font-bold mb-6 transition-colors"
        >
        ...
        {/* Header */}
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6 border-t-4 border-[#D40511]">
          <div className="flex items-start justify-between">
            ...
            <button
              ...
              disabled={scraping}
              className="flex items-center gap-2 bg-[#D40511] hover:bg-[#a0040d] text-white px-6 py-3 rounded-sm transition-colors font-bold uppercase tracking-wide shadow-lg disabled:opacity-50"
            >
            ...
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-4 font-bold uppercase tracking-wide transition-colors ${
                  activeTab === tab.id
                    ? 'border-b-4 border-[#D40511] text-[#D40511]'
                    : 'text-gray-600 hover:text-[#D40511]'
                }`}
              >
          ...
          <div className="p-6">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                {/* Checkout Position */}
                <div className="bg-gradient-to-br from-[#FFCC00]/20 to-white p-6 rounded-lg border-2 border-[#FFCC00]">
                  ...
                  {latestMonitoring ? (
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="text-3xl font-black text-[#D40511]">
                ...
                {customer.website_analysis && (
                  <div className="bg-white p-6 rounded-lg border-2 border-gray-200">
                    <h3 className="text-xl font-black text-black uppercase mb-4 flex items-center gap-2">
                      <Globe className="w-6 h-6 text-[#D40511]" />
                      Webbplats-analys
                    </h3>
                ...
                <div className="bg-white p-6 rounded-lg border-2 border-gray-200">
                  <h3 className="text-xl font-black text-black uppercase mb-4 flex items-center gap-2">
                    <Clock className="w-6 h-6 text-[#D40511]" />
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-4 gap-4 text-sm">
                              <div>
                                ...
                                <span className="ml-2 font-black text-[#D40511]">#{record.dhl_position || 'N/A'}</span>
                              </div>
                              <div>
            ...
            {activeTab === 'notes' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button className="flex items-center gap-2 bg-[#D40511] hover:bg-[#a0040d] text-white px-4 py-2 rounded-sm transition-colors font-bold text-sm uppercase">
