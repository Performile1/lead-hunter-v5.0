...
export const CustomerCard: React.FC<CustomerCardProps> = ({ customerId, onClose, onUpdate }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#FFCC00]/10 to-white p-6 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#D40511] mx-auto mb-4"></div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFCC00]/10 to-white p-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Header Card */}
        <div className="bg-white rounded-sm shadow-lg border-t-4 border-[#FFCC00] mb-6">
          <div className="p-6">
            ...
            <div className="flex items-start justify-between mb-6">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <Building className="w-8 h-8 text-[#D40511]" />
                  {isEditing ? (
                    <input
                      type="text"
                      value={editData?.company_name || ''}
                      onChange={(e) => setEditData(prev => prev ? {...prev, company_name: e.target.value} : null)}
                      className="text-2xl font-bold text-slate-800 border-b-2 border-[#FFCC00] focus:outline-none flex-1"
                    />
                  ) : (
                ...
                <div className="flex items-center gap-2 text-slate-600 mb-3">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="border-b border-slate-300 focus:outline-none focus:border-[#FFCC00]"
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {customer.uses_dhl && (
                    <span className="px-3 py-1 rounded-sm text-xs font-bold uppercase border bg-[#FFCC00] text-[#D40511] border-[#D40511]">
                      Använder DHL
                    </span>
                  )}
                </div>
                ...
                {isEditing ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-300 text-[#D40511] hover:bg-[#D40511] hover:text-white rounded-sm font-bold"
                    >
                ...
                <div className="flex-1">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="w-full border-b border-slate-300 focus:outline-none focus:border-[#FFCC00]"
        ...
        {customer.decision_makers && customer.decision_makers.length > 0 && (
          <div className="bg-white rounded-sm shadow-lg border-t-4 border-[#FFCC00] mb-6 p-6">
            <h2 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
              <User className="w-5 h-5 text-[#D40511]" />
              Beslutsfattare
            </h2>
            <div className="space-y-3">
              {customer.decision_makers.map((dm, index) => (
                <div key={index} className="border-l-4 border-[#FFCC00] pl-4 py-2">
        ...
        {/* Notes Section */}
        <div className="bg-white rounded-sm shadow-lg border-t-4 border-[#FFCC00] p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-[#D40511] hover:bg-[#B00410] text-white rounded-sm text-sm font-bold"
            >
            ...
            <div className="mb-4 p-4 bg-slate-50 rounded-sm border border-slate-200">
              <div className="mb-3">
                ...
                <select
                  ...
                  className="w-full border border-slate-300 rounded-sm px-3 py-2 focus:outline-none focus:border-[#FFCC00]"
                >
              ...
              <div className="mb-3">
                ...
                <textarea
                  ...
                  className="w-full border border-slate-300 rounded-sm px-3 py-2 focus:outline-none focus:border-[#FFCC00] h-24"
          ...
          {customer.notes && customer.notes.length > 0 ? (
            <div className="space-y-3">
              {customer.notes.map((note, index) => (
                <div key={note.id || index} className="border-l-4 border-[#FFCC00] pl-4 py-3 bg-slate-50">
