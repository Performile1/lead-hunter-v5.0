            ...
            <div>
              ...
              <form onSubmit={handleCreate} className="space-y-3">
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-black text-white py-2 px-4 text-xs font-bold uppercase tracking-wider hover:bg-[#a0040d] transition-colors shadow-sm rounded-sm disabled:opacity-50"
                >
