...
export const ProcessingStatusBanner: React.FC<ProcessingStatusBannerProps> = ({
  ...
  return (
    <div className="bg-slate-900 text-white shadow-lg border-b-4 border-[#D40511] sticky top-0 z-40 animate-slideDown">
      <div className="max-w-[1600px] mx-auto px-4 py-3 flex items-center justify-between gap-4">
        
        <div className="flex items-center gap-3 min-w-0">
          <div className="bg-[#D40511] p-2 rounded-full animate-pulse">
