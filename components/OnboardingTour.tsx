    ...
    <div className="fixed inset-0 z-[100] pointer-events-none">
        ...
        >
            ...
            <div className="flex items-center justify-between mt-2 pt-4 border-t border-slate-100">
                ...
                <button
                    onClick={handleNext}
                    className="flex items-center gap-1 bg-black hover:bg-[#FFC400] hover:text-black text-white px-4 py-2 text-xs font-bold uppercase tracking-wider shadow-md transition-colors"
                >
