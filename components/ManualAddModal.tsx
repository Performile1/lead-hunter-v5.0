      ...
      <div className="bg-white w-full max-w-md shadow-2xl border-t-4 relative">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="pt-2">
             <button
              type="submit"
              className="w-full bg-black hover:bg-[#FFC400] hover:text-black text-white py-2 px-4 text-sm font-bold uppercase tracking-wider shadow-sm transition-colors rounded-sm"
             >
                Lägg till i Listan
             </button>
