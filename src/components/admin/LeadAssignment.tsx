  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg p-4 shadow-sm">
      <div className="flex items-center gap-2 mb-3">
        <UserPlus className="w-5 h-5 text-[#D40511]" />
      ...
      <div className="space-y-3">
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:border-[#D40511] focus:ring-1 focus:ring-[#D40511]"
          >
        ...
        <button
          ...
          className="w-full bg-[#D40511] text-white px-4 py-2 rounded-lg hover:bg-[#B00410] disabled:bg-slate-300 disabled:cursor-not-allowed font-semibold text-sm uppercase tracking-wide transition-colors"
        >
